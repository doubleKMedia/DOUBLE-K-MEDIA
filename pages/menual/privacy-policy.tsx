...
const PrivacyPolicy: NextPage = () => {
  ...
  return (
    <Menual title={TITLE} description={DESCRIPTION}>
      ...
      <span className="body">
        더블케이미디어(이하 ‘회사’라 한다)는 개인정보 보호법 제30조에 따라 정보 주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수
        ...
        직책 : 대표
        <br />
        연락처 : &lt;031-233-9534&gt;, &lt;double_k_media@naver.com&gt;
        <br />
        ※ 개인정보 보호 담당부서로 연결됩니다.
        <br />
        <br />
        ...
        <br />이 개인정보 처리방침은 2022. 6. 4부터 적용됩니다.
      </span>
